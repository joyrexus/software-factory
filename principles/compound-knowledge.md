...
Both Klaassen and Factory.ai converge on a specific mechanism: a file at the repository root that encodes compound knowledge for agents. Klaassen calls it AGENTS.md and structures it with workflow commands. Factory.ai's version answers three questions: how to build/test/lint, how the codebase is organized, and what evidence must accompany a pull request.
