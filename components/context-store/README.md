...
- [Attractor](../attractor/README.md) — Pipeline orchestrator that produces context for the store
- [Agent Identity](../agent-identity/README.md) — Access control for who can read and write context
