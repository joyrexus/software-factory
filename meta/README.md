...
- **[Three lineages](paradigm.md)** — traces compound engineering (Larson), agent-native development (Factory.ai), and the software factory vision (StrongDM) to their common destination
