...
**[A game plan:](game-plan.md)** [Assess and prove](game-plan.md#phase-1-assess-and-prove) → [Prepare the environment](game-plan.md#phase-2-prepare-the-environment) → [Start delegating](game-plan.md#phase-3-start-delegating) → [Shift the culture](game-plan.md#phase-4-shift-the-culture). Start small, compound fast — [what remains unproven](#what-remains-unproven) bounds how aggressively to invest.
...
The phased approach — assess, prepare, delegate, shift — is now maintained as a standalone document: **[A Game Plan](game-plan.md)**. See that file for the full four-phase breakdown with concrete action items at each stage.
