...
| [sdlc/](sdlc/README.md) | Spec-driven agentic SDLC — a workflow architecture composing agent-native practices into an end-to-end development lifecycle, with architecture patterns, adoption roadmap, and a 90-day pilot guide |
