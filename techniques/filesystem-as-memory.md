...
The filesystem is the most natural memory substrate for coding agents. Directories serve as namespaces, filenames as keys, file contents as values, and README files as navigable tables of contents. An agent that can read and write files has persistent, structured, queryable memory — without any additional infrastructure.
...
```
principles/README.md → principles/seed.md
techniques/README.md → techniques/filesystem-as-memory.md
components/README.md → components/attractor/README.md → components/attractor/00-overview/...
```
...
**README files at every level** serve as both navigation and summary. A README answers the question "what's in this directory and why should I care?" without requiring the reader to open every file.
